(() => {
  ...
  function Be(t, e) {
    return (
      Ae || (Ae = document.createElement("a")), (Ae.href = e), t === Ae.href
    );
  }
  function bt(t) {
    ...
    s && s.m(e, n),
      r ||
        qe(() => {
          ...
          t.$$.on_destroy ? t.$$.on_destroy.push(...i) : V(i),
            (t.$$.on_mount = []);
        }),
      l.forEach(qe);
  }
  ...
  function xt(t) {
    ...
    return (
      t[6] !== void 0 && (l.selected_filters = t[6]),
      (e = new Bt({ props: l })),
  ...
  function cs(t) {
    let e = t[16]("zero_results").replace(/\[SEARCH_TERM\]/, t[13]) + "",
      n;
    return {
      c() {
        n = O(e);
      ...
      p(r, s) {
        s[0] & 8192 &&
          e !==
            (e =
              r[16]("zero_results").replace(/\[SEARCH_TERM\]/, r[13]) + "") &&
          $(n, e);
      },
      d(r) {
        r && R(n);
  ...
  function Yt(t) {
    let e,
      n = t[16]("searching").replace(/\[SEARCH_TERM\]/, t[13]) + "",
      r;
    return {
      c() {
        (e = y("p")),
  ...
  function _s(t, e, n) {
    ...
    Ve(() => {
      ...
      ht =
        r[`${T.language}-${T.script}-${T.region}`] ||
        r[`${T.language}-${T.region}`] ||
        r[`${T.language}`] ||
        r.en;
    });
    let mt = async () => {
